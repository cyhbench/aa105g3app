...
class ChefOrderListUpdateForChefTask extends AsyncTask<Object, Integer, Integer> {
...
//                chef_order_listVO.getChef_appr_cnt(), "2");
        ...
        String chef_ord_no = params[9].toString();
//        String chef_ord_con = params[8].toString();
...
//        String json = gson.toJson(memberVO);
        ...
        jsonObject.addProperty("chef_ord_con", chef_ord_con);
