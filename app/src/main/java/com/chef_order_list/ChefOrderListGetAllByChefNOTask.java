...
public class ChefOrderListGetAllByChefNOTask extends AsyncTask<Object, Integer, List<Chef_order_listVO>>{
    private final static String TAG = "私廚訂單得全ByMemNOTask";
    private final static String ACTION = "findByChef_no";
