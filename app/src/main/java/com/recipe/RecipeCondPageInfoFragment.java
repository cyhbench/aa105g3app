...
public class RecipeCondPageInfoFragment extends Fragment {
    ...
    private ImageView iv_recipe_cond_page_info_recipe_pic;
    private TextView tv_recipe_cond_page_info_recipe_name;
    private TextView tv_recipe_cond_page_info_recipe_intro;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.recipe_cond_page_info_fragment, container, false);
...
//        }
//        Log.d(TAG, "info!!! recipeVO.getRecipe_no():" + recipeVO.getRecipe_no());
//        Log.d(TAG,"info!!! recipe_contVOSet.isEmpty():"+recipe_contVOSet.isEmpty());
...
//        mem_own = pref.getString("mem_own", "");
        ...
        iv_recipe_cond_page_info_recipe_pic = (ImageView) view.findViewById(R.id.iv_recipe_cond_page_info_recipe_pic);
        tv_recipe_cond_page_info_recipe_name = (TextView) view.findViewById(R.id.tv_recipe_cond_page_info_recipe_name);
        tv_recipe_cond_page_info_recipe_intro = (TextView) view.findViewById(R.id.tv_recipe_cond_page_info_recipe_intro);
...
//        切食材的字串出來 (from冠宇)
        ...
        tv_recipe_cond_page_info_recipe_name.setText(recipeVO.getRecipe_name());
        tv_recipe_cond_page_info_recipe_intro.setText(recipeVO.getRecipe_intro());

        String url = Common.URL + "RecipeServletAndroid";
        String recipe_no = recipeVO.getRecipe_no();
//            String mem_no = memberVO.getMem_no();
        int imageSize = 1024;
        new RecipeGetImageTask(iv_recipe_cond_page_info_recipe_pic).execute(url, recipe_no, imageSize);

//        Bitmap bitmap = BitmapFactory.decodeByteArray(recipeVO.getRecipe_pic(), 0, recipeVO.getRecipe_pic().length);
//        iv_recipe_cond_page_info_recipe_pic.setImageBitmap(bitmap);

//        new RecipeFragment.RecipeGetImageTaskk(viewHolder.iv_recipe_pic).execute(url, recipe_no, imageSize);

//        rvRecipeVO.setAdapter(new RecipeCondPageInfoFragment.RecipeRecyclerViewAdapter(getActivity(), ingredients, quantity));
    }
...
//    private class RecipeRecyclerViewAdapter extends RecyclerView.Adapter<RecipeCondPageInfoFragment.RecipeRecyclerViewAdapter.ViewHolder> {
...
//
//        @Override
//        public RecipeCondPageInfoFragment.RecipeRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
//            View itemView = layoutInflater.inflate(R.layout.recipe_cond_page_mater_item, parent, false);
//            return new RecipeCondPageInfoFragment.RecipeRecyclerViewAdapter.ViewHolder(itemView);
//        }
//
//        @Override
//        public void onBindViewHolder(RecipeCondPageInfoFragment.RecipeRecyclerViewAdapter.ViewHolder viewHolder, int position) {
