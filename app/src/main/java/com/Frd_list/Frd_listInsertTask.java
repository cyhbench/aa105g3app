...
public class Frd_listInsertTask extends AsyncTask<Object, Integer, Frd_listVO> {
    String TAG = "新增好友";
    ...
    protected Frd_listVO doInBackground(Object... params) {
        ...
        String friend_no =  params[3].toString();
        String jsonIn;
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("action", ACTION);
        jsonObject.addProperty("mem_no", mem_no);
        jsonObject.addProperty("friend_no", friend_no);
