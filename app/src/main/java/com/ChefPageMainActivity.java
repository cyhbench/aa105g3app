...
public class ChefPageMainActivity extends AppCompatActivity {
    private static final String TAG = "ChefPageMainActivity";
    private String url = Common.URL + "ChefServletAndroid";
    private byte[] image;
...
//    private Button bt_member_page_recipe_insert;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chef_page_main_activity);
        final Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("分享食光:私廚個人頁面");
        setSupportActionBar(toolbar);

//        ViewPager viewPager = (ViewPager) findViewById(R.id.viewPager);
//        viewPager.setAdapter(new ChefPageMainActivity.MyPagerAdapter(getSupportFragmentManager()));
//
...
//        Button bt_member_page_recipe_insert = (Button) findViewById(R.id.bt_member_page_recipe_insert);
        ...
        if (Common.networkConnected(this)) {
            ...
            try {
                ...
                Log.d(TAG,"ChefGetOneByMemNoTask:url:" + url);
            ...
            if (memberVO == null) {
                Common.showToast(this, R.string.msg_NoChefsFound);
            } else {
...
//            Bundle bundle = new Bundle();
            ...
            pageList.add(new Page(chefInfoFragment, "簡介"));
