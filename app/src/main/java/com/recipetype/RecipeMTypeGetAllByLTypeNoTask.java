...
public class RecipeMTypeGetAllByLTypeNoTask extends AsyncTask<Object, Integer, List<Recipe_m_typeVO>>{
    private final static String TAG = "RcpMTypeGetAllByLNOTask";
    private final static String ACTION = "getM_typesByL_Type_No";

    @Override
    protected List<Recipe_m_typeVO> doInBackground(Object... params) {
        String jsonIn;
        ...
        Type listType = new TypeToken<List<Recipe_m_typeVO>>() {
        }.getType();
