...
import com.recipe.RecipeGetAllByRecipe_type_noTask;
...
/*Qoo*/
public class RecipeSTypeFragment extends Fragment {
    private List<RecipeVO> recipeVOList = new ArrayList<RecipeVO>();
    private static final String TAG = "RecipeSTypeFragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.recipe_s_fragment, container, false);
        ...
        recipe_s_type_no = (String) getArguments().getSerializable("recipe_s_type_no");
        String recipe_s_type_name = (String) getArguments().getSerializable("recipe_s_type_name");

        choosing_type = (TextView) view.findViewById(R.id.choosing_type);
        choosing_type.setText("所有 " + recipe_s_type_name + " 的食譜");
...
//            } else {
//                rvRecipeTypeVO.setAdapter(new RecipeSTypeFragment.RecipeTypeRecyclerViewAdapter(getActivity(), recipe_s_typeVOList));
//            }
//        } else {
...
//            list.clear();
            ...
            try {
                list = new RecipeGetAllByRecipe_type_noTask().execute(url, recipe_s_type_no).get();
            } catch (Exception e) {
                Log.e(TAG, e.toString());
            }
            ...
            if (recipeVOList == null || recipeVOList.isEmpty()) {
                ...
                rvRecipeVO.setAdapter(new RecipeSTypeFragment.RecipeRecyclerViewAdapter(getActivity(), recipeVOList));
            }
        } else {
            Common.showToast(getActivity(), R.string.msg_NoNetwork);
        }
    ...
    private class RecipeRecyclerViewAdapter extends RecyclerView.Adapter<RecipeSTypeFragment.RecipeRecyclerViewAdapter.ViewHolder> {
        ...
        @Override
        public RecipeSTypeFragment.RecipeRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = layoutInflater.inflate(R.layout.browse_recipe_item, parent, false);
            return new RecipeSTypeFragment.RecipeRecyclerViewAdapter.ViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(RecipeSTypeFragment.RecipeRecyclerViewAdapter.ViewHolder viewHolder, int position) {
...
//
//    public class RecipeTypeRecyclerViewAdapter extends RecyclerView.Adapter<RecipeSTypeFragment.RecipeTypeRecyclerViewAdapter.TypeViewHolder> {
//        private LayoutInflater layoutInflater;
//        private List<Recipe_s_typeVO> recipe_s_typeVOList;
//
...
//
//        @Override
//        public RecipeSTypeFragment.RecipeTypeRecyclerViewAdapter.TypeViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
//            View itemView = layoutInflater.inflate(R.layout.recipe_l_type_item, parent, false);
//            return new RecipeSTypeFragment.RecipeTypeRecyclerViewAdapter.TypeViewHolder(itemView);
//        }
//
//        @Override
//        public void onBindViewHolder(RecipeSTypeFragment.RecipeTypeRecyclerViewAdapter.TypeViewHolder viewHolder, int position) {
