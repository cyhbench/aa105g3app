...
public class CollectionDetailMemberMainActivity extends AppCompatActivity {
    private static final String TAG = "logColDtlMemManActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("我的收藏-會員");
        setSupportActionBar(toolbar);
        Log.d(TAG, "mainactivity test 63");
    ...
    protected void onStart() {
        ...
        if (Common.networkConnected(this)) {
            ...
            try {
                memberVO = new MemberGetOneTask().execute(url, memberVO.getMem_no()).get();
