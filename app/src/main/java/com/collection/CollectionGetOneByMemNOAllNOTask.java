...
public class CollectionGetOneByMemNOAllNOTask extends AsyncTask<Object, Integer, Boolean>{
    private final static String TAG = "用會員號與全號判斷是否追隨:";
    private final static String ACTION = "findByMem_noAndAll_no";
    ...
    private String getRemoteOneData(String url, String jsonOut) throws IOException {
        ...
        if (responseCode == 200) {
            ...
            Log.d(TAG, "response code(CollectionGetAllByMemNOTask.getRemoteData.74line): " + responseCode);
        }
