 ...
 */
//加入收藏
public class CollectionDeleteTask extends AsyncTask<Object, Integer, List<CollectionVO>>{
    private final static String TAG = "CollectionDeleteTask";
